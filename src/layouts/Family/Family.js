    ...
    <div className="container-wrapper">
      <div className="mb-50px">
        <div className={styles.titles}>
          <h1 className="text-center white weight-9 fs-48px mb-10px">
            OUR FAMILY
          </h1>
          <p className="fs-16px weight-4 white text-center font-open-sans lh-1_7">
      ...
      <div className={styles.cards}>
        ...
        <FamilyCard img={familyimg2} title="Cactus jack" subtitle="Branding" />
        <FamilyCard img={familyimg3} title="Frenchy Gentiks" subtitle="Weed" />
      </div>
    </div>
  );
}
